    ...
    methods:{
        async haddleUpdate(){
            if(this.newPassword === this.oldPassword){
                ...
                const statusUpdate = await axios.put("http://127.0.0.1:3000/updateprofile",payload);
        ...
        <div class="set-update">
            <div class="password-container">
                <div class="set-password">
                    <input class="set-new-password" placeholder="Enter your new password" v-model="newPassword" type="password"/>
                </div>
                <div class="set-password">
                    <input class="set-new-password" placeholder="Confirm your password" v-model="oldPassword" type="password"/>
                </div>
